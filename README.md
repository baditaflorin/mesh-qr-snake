...
Live: **https://baditaflorin.github.io/mesh-qr-snake/**

Source: **https://github.com/baditaflorin/mesh-qr-snake**
...
git clone https://github.com/baditaflorin/mesh-qr-snake
cd mesh-qr-snake
npm install
npm run dev
```
...
- `mesh-qr-snake:signalingUrl`
- `mesh-qr-snake:turnTokenUrl`
- `mesh-qr-snake:iceServers`
- `mesh-qr-snake:room`
